...
wget -q --show-progress --https-only --timestamping \
  "https://storage.googleapis.com/kubernetes-release/release/$(curl "https://storage.googleapis.com/kubernetes-release/release/v1.19.0/bin/linux/amd64/kube-scheduler") \
/bin/linux/amd64/kube-apiserver" \
  "https://storage.googleapis.com/kubernetes-release/release/$(curl "https://storage.googleapis.com/kubernetes-release/release/v1.19.0/bin/linux/amd64/kube-scheduler")/bin/linux/amd64/kube-controller-manager") \
  "https://storage.googleapis.com/kubernetes-release/release/$(curl "https://storage.googleapis.com/kubernetes-release/release/v1.19.0/bin/linux/amd64/kube-scheduler")/bin/linux/amd64/kube-scheduler") \
  "https://storage.googleapis.com/kubernetes-release/release/$(curl "https://storage.googleapis.com/kubernetes-release/release/v1.19.0/bin/linux/amd64/kube-scheduler")/bin/linux/amd64/kubectl")
```
